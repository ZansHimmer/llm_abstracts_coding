...
for f in Path("outputs_2_gpt-4.1-mini_bs-5").glob("*.txt"):
    tmp = pd.read_csv(
        f,
        header=None,
...
output_path = (
    "matched_sheets\\matched_master_sheet_2_gpt-4.1-mini_bs-5_with_positions.xlsx"
)
...
with pd.ExcelWriter(
    "evaluations\\evaluation_by_position_2_gpt-4.1-mini_bs-5.xlsx",
    engine="openpyxl"
) as writer:
