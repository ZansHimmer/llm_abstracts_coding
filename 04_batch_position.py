...
for f in Path("outputs_2_gpt-5-mini").glob("*_coding_output_2.txt"):
    tmp = pd.read_csv(
        f,
        header=None,
...
output_path = "matched_master_sheet_2_gpt-5-mini_with_positions.xlsx"
...
results_df.to_excel("evaluation_by_position_2_gpt-5-mini.xlsx", index=False)
report_df.to_excel("detailed_report_by_position_2_gpt-5-mini.xlsx", index=False)